...
an average of $10\times$ fewer CNOT gates and $5.2\times$ fewer U3 gates. an average $5.7\times$ decrease of the circuit critical path and an $1.03\times$ better parallelism.
\end{frame}
