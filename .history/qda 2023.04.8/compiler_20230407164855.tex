...
\begin{figure}
  \includegraphics[width=.8\textwidth]{figure/top-down.png}
  \capttion{Top-down synthesizers,decompose large unitaries into smaller ones while maintaining equality}
\end{figure}
% figure here
\end{frame}
