...
%	need hypergraph
	...
	\begin{frame}{Application to UCC Circuits}
		\begin{columns}
			...
			\column{.45\textwidth}
%			\begin{figure}
%				\includegraphics[width=\linewidth]{figures/algo_comparison_UCC_6to20.pdf}
%				\caption{Entanglement cost vs~qubits.}
%			\end{figure}
...
%		\begin{itemize}
%			\item Introduced \textbf{packing/embedding} framework for bipartite DQC.
%			\item \textbf{Graph representation} gives algorithmic way to minimise ebits.
%			\item Demonstrated large savings on realistic UCC circuits.
%			\item Framework extendable to multi‑party networks \& modular architectures.
%		\end{itemize}
%	\end{frame}
	\section{WIP}
