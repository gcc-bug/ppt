...
\begin{frame}
  \begin{figure}
    \subfigure{\includegraphics[width=.3\linewidth angle = 180]{m1.jpg}}
    \subfigure{\includegraphics[width=.3\linewidth]{m2.jpg}}
    \\
    \subfigure{\includegraphics[width=.3\linewidth]{m3.jpg}}
    \subfigure{\includegraphics[width=.3\linewidth]{m4.jpg}}
  \end{figure}
\end{frame}
\end{document}