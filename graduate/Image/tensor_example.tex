...
\begin{document}
\begin{tikzpicture}[shorten >=1pt,node distance=3cm,on grid,auto,line width=1pt, every edge/.style={draw, -},every node/.style={font=\large},line width =1pt]
  ...
  \path[->] 
        ...
        (s2) edge[bend right=10] node {$x_0$} (c0)
