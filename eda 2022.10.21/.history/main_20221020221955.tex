...
\begin{frame}{result}
  \begin{table}[]
    \begin{tabular}{ccccc}
      \hline & \multicolumn{2}{c}{\text { Hand-optimized }} & & \multicolumn{2}{c}{\text { Non-optimized }} \\
      \cline { 2 - 3 } \cline { 6 - 7 } & \text { Qubits } & \text { cost } & & \text { Qubits } & \text { cost } \\
      \hline \text { IBM's solution } & 32 & 5004 & & \\
