...
\begin{frame}{XAG}
  \begin{algorithm}[H]
    ...
    \begin{algorithmic}
      ...
      \STATEset  $L_{1} \leftarrow \operatorname{ltfi}\left(x_{j}\right), L_{2} \leftarrow \operatorname{ltfi}\left(x_{k}\right) $
      \IF{$L_{1} \subseteq L_{2}$}
      \STATEswap $L_1 \leftrightarrow L_2$ and $p \leftrightarrow q$
      \ENDIF
