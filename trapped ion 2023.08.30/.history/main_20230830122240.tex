...
\begin{frame}
  ...
  \begin{table}[]
    ...
    \end{tabular}
  \end{table}
  \(<F>=97.5\%\) for any two qu out of 13 qubits\url{https://investors.ionq.com/news/news-details/2018/IonQ-harnesses-single-atom-qubits-to-build-the-worlds-most-powerful-quantum-computer/default.aspx}
\end{frame}
\begin{frame}
