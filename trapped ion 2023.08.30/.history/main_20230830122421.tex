...
\begin{frame}
  ...
  \begin{table}[]
    ...
    \end{tabular}
  \end{table}
  \(average Fidelity >98\%\) for any two qu out of 13 qubits, form \href{https://investors.ionq.com/news/news-details/2018/IonQ-harnesses-single-atom-qubits-to-build-the-worlds-most-powerful-quantum-computer/default.aspx}{IonQ news}
\end{frame}
\begin{frame}
