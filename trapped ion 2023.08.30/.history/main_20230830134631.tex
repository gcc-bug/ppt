...
\begin{frame}
  ...
  \begin{enumerate}
    ...
    \item Azimuthal Quantum Number \(\ell =0,\dots,(n-1)\)
    \item Magnetic Quantum Number \(m_\ell=-l,\dots,l\)
...
\begin{frame}
  ...
  \begin{figure}
    ...
    \caption{copy from \footcite{https://www.geeksforgeeks.org/quantum-numbers/}}
  \end{figure}
\end{frame}
\begin{frame}
...
\begin{frame}
  ...
  The total angular momentum quantum number: \(j=|\ell\pm s|\)
  \begin{figure}
...
\begin{frame}
  ...
  \begin{figure}
    \includegraphics[width= .8\textwidth]{sideband.png}
...
\begin{frame}
  ...
  \begin{figure}
    \includegraphics[width=.8\textwidth]{1280px-Paul-Trap.svg.png}
