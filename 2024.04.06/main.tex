...
% \begin{enumerate}
%   \item \textbf{Thermal Noise:} Random thermal fluctuations affecting the system.
%   \item \textbf{Quantum Decoherence:} Loss of quantum information due to interaction with the environment.
%   \item \textbf{Control Errors:} Imperfections in the implementation of quantum gates.
%   \item \textbf{Measurement Errors:} Inaccuracies when measuring qubits.
% \end{enumerate}
\begin{enumerate}
...
\begin{frame}{reconfigurable atom arrays}
  \begin{figure}
    ...
    % gate time scale 200 ns
    % movement  100 to 200 ms
    % 300 ms for rearrange
  \end{figure}
\end{frame}
